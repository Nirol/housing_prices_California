...
from src.models_lib.initial_model_try import initial_model_test_top3_estimators
...
if __name__ == '__main__':
    ...
    initial_model_test_top3_estimators(train_test_result_dict["train_x"],train_test_result_dict["train_y"])
